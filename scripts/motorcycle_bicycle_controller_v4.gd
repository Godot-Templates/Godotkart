...
var engine_acceleration: float = 12.5
var brake_deceleration: float = 34.0
var reverse_acceleration: float = 8.0
var coast_deceleration: float = 2.0
var max_forward_speed: float = 42.0
var max_reverse_speed: float = 9.0
var wheelbase: float = 2.15
var max_low_speed_steer: float = 0.54
var max_high_speed_steer: float = 0.46
var steering_response: float = 22.0
var high_speed_curvature_scale: float = 1.75
var turn_lateral_grip: float = 36.0
var max_lean: float = 0.436332
var max_drift_lean: float = 0.523599
var lean_response: float = 14.0
var suspension_rest_length: float = 0.62
var suspension_stiffness: float = 15000.0
var suspension_compression_damping: float = 2600.0
var suspension_rebound_damping: float = 3600.0
var suspension_max_force: float = 13000.0
var lateral_velocity_damping: float = 56.0
var rolling_resistance: float = 0.045
var air_drag: float = 0.008
var aero_downforce: float = 1.10
var max_vertical_speed: float = 18.0
var rear_wheel_radius: float = 0.60
var front_wheel_radius: float = 0.52
var visual_smoothing: float = 13.0
...
var boost_fx_wind_enabled: bool = true
var obstacle_probe_distance: float = 2.1
var obstacle_probe_speed_lookahead: float = 0.08
var obstacle_wall_normal_max_up: float = 0.55
var wall_slide_speed_retention: float = 0.995
var wall_bounce_strength: float = 0.16
var wall_bounce_max_speed: float = 1.6
var wall_unstick_push_speed: float = 0.85
...
func _apply_kart_stats() -> void:
    ...
    if active_stats == null:
        active_stats = DEFAULT_KART_STATS
        kart_stats = active_stats
    engine_acceleration = active_stats.engine_acceleration
    brake_deceleration = active_stats.brake_deceleration
    reverse_acceleration = active_stats.reverse_acceleration
    coast_deceleration = active_stats.coast_deceleration
    max_forward_speed = active_stats.max_forward_speed
    max_reverse_speed = active_stats.max_reverse_speed
    wheelbase = active_stats.wheelbase
    max_low_speed_steer = active_stats.max_low_speed_steer
    max_high_speed_steer = active_stats.max_high_speed_steer
    steering_response = active_stats.steering_response
    high_speed_curvature_scale = active_stats.high_speed_curvature_scale
    turn_lateral_grip = active_stats.turn_lateral_grip
    max_lean = active_stats.max_lean
    max_drift_lean = active_stats.max_drift_lean
    lean_response = active_stats.lean_response
    suspension_rest_length = active_stats.suspension_rest_length
    suspension_stiffness = active_stats.suspension_stiffness
    suspension_compression_damping = active_stats.suspension_compression_damping
    suspension_rebound_damping = active_stats.suspension_rebound_damping
    suspension_max_force = active_stats.suspension_max_force
    lateral_velocity_damping = active_stats.lateral_velocity_damping
    rolling_resistance = active_stats.rolling_resistance
    air_drag = active_stats.air_drag
    aero_downforce = active_stats.aero_downforce
    max_vertical_speed = active_stats.max_vertical_speed
    rear_wheel_radius = active_stats.rear_wheel_radius
    front_wheel_radius = active_stats.front_wheel_radius
    visual_smoothing = active_stats.visual_smoothing
    camera_base_fov = active_stats.camera_base_fov
    ...
    obstacle_probe_distance = active_stats.obstacle_probe_distance
    obstacle_probe_speed_lookahead = active_stats.obstacle_probe_speed_lookahead
    obstacle_wall_normal_max_up = active_stats.obstacle_wall_normal_max_up
    wall_slide_speed_retention = active_stats.wall_slide_speed_retention
    wall_bounce_strength = active_stats.wall_bounce_strength
    wall_bounce_max_speed = active_stats.wall_bounce_max_speed
    wall_unstick_push_speed = active_stats.wall_unstick_push_speed
